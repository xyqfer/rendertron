...
class Renderer {
    ...
    async serialize(requestUrl, isMobile, timezoneId) {
        ...
        try {
            ...
            response = await page.goto(requestUrl, { timeout: this.config.timeout, waitUntil: 'networkidle0' });
        }
        catch (e) {
            console.error(e);
        }
    ...
    async screenshot(url, isMobile, dimensions, options, timezoneId) {
        ...
        const screenshotOptions = { type: (options === null || options === void 0 ? void 0 : options.type) || 'jpeg', encoding: (options === null || options === void 0 ? void 0 : options.encoding) || 'binary' };
